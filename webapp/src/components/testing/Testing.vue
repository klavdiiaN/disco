<template>
    ...
    <div class="flex flex-col gap-16">
      <div v-if="memoryStore.models.size > 0">
        <IconCard title-placement="center">
          ...
          <template #content>
            ...
            to their training! Note that these models are currently stored
      ...
      <div v-else>
        <IconCard>
          ...
          <template #content>
            Disco failed to fetch any model from the remote server. Is the Disco
            server running?
          </template>
        </IconCard>
      </div>
  ...
  <div v-if="validationStore.step === 1 && currentTask !== undefined">
    ...
    <IconCard v-if="!validationStore.isOnlyPrediction" class="mb-4 md:mb-8">
      ...
      <template #content>
        ...
        dataset of choice was not used during the training phase of your model.
      </template>
    </IconCard>

    <Data :task="currentTask" @dataset="setDataset" />
  </div>

  <div
    v-if="
      validationStore.step === 2 &&
